...
- **Branch:** `main`
- **Ultimo commit:** step 11 (`deploy/*` finalizzati: install.sh con ACL chirurgiche + drop-in systemd `ReadWritePaths` derivato da `config.yaml`, unit hardened, Dockerfile/compose, snippet cloudflared) — `__STEP11_HASH__`.
- **Working tree:** clean.
